...
Register-ArgumentCompleter -Native -CommandName 'prog' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'prog' {
            ...
            [CompletionResult]::new('--store-dir.another.sub-level', 'store-dir.another.sub-level', [CompletionResultType]::ParameterName, 'A flag with a second sublevel, sometimes with dashes')
            ...
            [CompletionResult]::new('--store-dir.dir', 'store-dir.dir', [CompletionResultType]::ParameterName, 'A flag which has a dash and a subtree. The dash should is part of the main key, and not a delimititer for the subtree')
            [CompletionResult]::new('-L', 'L', [CompletionResultType]::ParameterName, 'The other subtree element has a dash as well')
            [CompletionResult]::new('--store-dir.log-level', 'store-dir.log-level', [CompletionResultType]::ParameterName, 'The other subtree element has a dash as well')
