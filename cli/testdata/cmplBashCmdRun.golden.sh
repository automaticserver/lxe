...
_prog_completion_bash()
{
    ...
    two_word_flags+=("-s")
    flags+=("--store-dir.another.sub-level=")
    two_word_flags+=("--store-dir.another.sub-level")
    flags+=("--store-dir.dir=")
    two_word_flags+=("--store-dir.dir")
    two_word_flags+=("-S")
    flags+=("--store-dir.log-level=")
    two_word_flags+=("--store-dir.log-level")
    two_word_flags+=("-L")
